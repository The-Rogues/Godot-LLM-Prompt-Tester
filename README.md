...
The project files include a gguf file, which is a data format for storing language models. This repository utilizes [gemma-2-2b-it-Q4_K_M](https://huggingface.co/bartowski/gemma-2-2b-it-GGUF/tree/main), which was downloaded from https://huggingface.co/bartowski/gemma-2-2b-it-GGUF/tree/main. Ideally, this project can use any gguf llm, but I haven't tested many, so there may be an exception.
...
* Download the zipfile from this repository and extract its contents somewhere that's easy to find
...
## How to change the GGUF/LLM model
* The latest version of Godot allows for the GGUF file to be stored in the same folder as the source files of the project
* Godot does not natively understand gguf files, so they are not visible in the editor environment, howeve,r they can be viewed in the computer's file system
* To change the LLM model, drag its gguf file into the same folder as the source files. (You should see https://huggingface.co/bartowski/gemma-2-2b-it-GGUF/tree/main.gguf in the same folder)
...
* Click and open the gguf file you want to use, and from there, you can press play and test the model
