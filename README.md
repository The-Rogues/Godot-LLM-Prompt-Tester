...
I tested this project using gemma-2-2b-it-Q4_K_M.gguf, which was downloaded from https://huggingface.co/bartowski/gemma-2-2b-it-GGUF/tree/main. Ideally, this project can use any gguf file/llm, but I haven't tested many, so there may be an exception.
...
* Godot does not natively understand gguf files, so they are not visible in the editor environment, howeveer they can be viewed in the computer's file system
